...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button b3=(Button) findViewById(R.id.buttonget);
        b3.setOnClickListener(new View.OnClickListener() {
            ...
            @Override public void onClick(View arg0) {
                ...
                try
                {
                    EditText ed1=(EditText)findViewById(R.id.iduser);
                    EditText ed2=(EditText)findViewById(R.id.bastip);
                    Integer x=Integer.parseInt(ed1.getText().toString());
                    Integer y=Integer.parseInt(ed2.getText().toString());
                    ...
                    Toast.makeText(MainActivity.this, rslt3, Toast.LENGTH_SHORT).show();
